...
class CategorysController extends Controller
{
    ...
    public function index_tag($tv ,$tags, $slug)
    {
      MyFunction::authorizes(['AdmincpSuper','Admincp']);
       ...
       $simo[] = "null" ;
        ...
        return view('admincp.Categorys.index_tags',[ "Categorys"=>$simo ,]);
    }
    ...
    public function index()
    {
      MyFunction::authorizes(['AdmincpSuper','Admincp']);
        ...
        $Categorys = Categorys::where('type', 'Categorys')->simplePaginate(12);

        return view('admincp.Categorys.index',[ "Categorys"=>$Categorys ,]);
    }
    /**
    ...
    public function create()
    {
      MyFunction::authorizes(['AdmincpSuper','Admincp']);
        ...
        return view('admincp.Categorys.add');
    }
    ...
    public function store(Request $request)
    {
      MyFunction::authorizes(['AdmincpSuper','Admincp']);
        ...
        $Categorys = Categorys::where('type', 'Categorys')->where('slug', $slug)->first() ;
        ...
        if (!isset($Categorys)) {
          ...
          $Categorys->slug = $slug;
          $Categorys->type = "Categorys";
          $Categorys->taxonomy = "Categorys";
          $Categorys->parent_id = '0';
          $Categorys->save();
        }
        return redirect('/admincp/Categorys/edit/'.$Categorys->id)->with('status', 'Profile updated!');
    }
    ...
    public function edit(Categorys $categorys , $id)
    {
      ...
      $Categorys = Categorys::where('type', 'Categorys')->where('id', $id)->first() ;
      return view('admincp.Categorys.edit',['Categorys'=>$Categorys,]);
    ...
    public function update(Request $request, Categorys $categorys , $id)
    {
      ...
      $Categorys = Categorys::where('type', 'Categorys')->find($id) ;
      if (isset($Categorys)) {
        $Categorys->name = $request->addTiltle;
        $Categorys->save();
      }
     ...
     */
     public function delete($id)
     {
       ...
       $user1->cate_meta()->where('taxonomy', 'Categorys')->delete();
       $user1->delete();
     ...
     public function destroy($id)
     {
       ...
       $user1->forceDelete();
       $user1->cate_meta()->where('taxonomy', 'Categorys')->forceDelete();
       return back();
     ...
     public function showdalet()
       ...
       return view('admincp.Categorys.Trashed',["Categorys" => $user1]);
