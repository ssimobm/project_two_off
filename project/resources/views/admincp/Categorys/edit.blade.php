@extends('master.add-post')
  ...
  @section('Post_id')
    ...
    <div class="col-12"> <div class="page-title-box"> <div class="page-title-right">
      ...
      <form action="{{ url('/admincp/Categorys/edit') }}/{{ $Categorys->id }}" enctype="multipart/form-data" method="post">


    @csrf


     <input type="text" id="simpleinput" name="addTiltle" class="form-control" placeholder="ADD Title" value="{{ $Categorys->name }}">
