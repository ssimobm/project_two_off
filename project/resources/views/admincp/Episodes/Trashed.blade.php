...
<div class="row">
  <div class="col-12">
    <div class="table-responsive">
          ...
          <a type="button" class="btn btn-light" href='{{ url('/admincp/episodes/restore/') }}/{{$value->id}}'>restore</a>
          <a type="button" class="btn btn-light" href='{{ url('/admincp/episodes/destroy/') }}/{{$value->id}}'>destroy</a>
