             ...
             <div class="page-title-box">
              <div class="row">
                ...
                <h3 class="text-md-left text-center" >
                  {{__('Settings.name_permission')}}
              </h3>
                 </div>
                <div class="col-lg-8 col-md-8 col-sm-4 col-12">
                <div class="text-md-right  py-2">
                  <a href="{{url('/admincp/options/roles')}}" type="button" class="btn btn-success  btn-sm mb-1 waves-effect waves-light">
                      <span class="btn-label"><i class="mdi mdi-check-all"></i></span>Roles
                  </a>
  ...
  <div class="col-12">
    ...
    <td>
      <div class="btn-group mb-2">
        @if ("App\Models\User"->UserMeta->UserRole->type == "role_admin")
  <a type="button" class="btn btn-light" href='{{ url('/admincp/options/roles/permissions/delet/') }}/{{$value->id}}'>Delet</a>
        @endif

          <a type="button" class="btn btn-light" href='{{ url('/admincp/options/roles/permissions/edit') }}/{{$value->id}}'>edit</a>
