...
<div class="container">
  ...
  <ul  class="list-group">
  <a href="{{ url('/admincp/options/users') }}" class="list-group-item list-group-item-action"><i class="fas fa-users mr-1"></i>{{__('All Users')}}</a>
  <a href="{{ url('/admincp/options/users/edit') }}/{{$id}}" class="list-group-item list-group-item-action"><i class="fas fa-user-edit mr-1"></i>{{__('Account Settings')}}</a>
  <a href="{{ url('/admincp/options/users/pass') }}/{{$id}}"  class="list-group-item list-group-item-action active_blue"  ><i class="fas fa-key mr-1"></i>{{ __('Edit Password')}}</a>
</ul>
...
<div class="col-lg-8 col-md-8 col-sm-12 col-12 py-0">
  <div class="card">
      ...
      {{ session('success') }}
        ...
        <form id="form-pass" method="POST" action="{{ url('/admincp/options/users/pass') }}/{{$id}}">
