...
<ul class="list-group d-none d-lg-block">
  <a href="{{url('/admincp/users/notifications')}}" class="list-group-item list-group-item-action active_blue"><i class="fas fa-bell mr-1"></i>{{__('Notification')}}</a>
  <a href="{{url('/admincp/users/favorit')}}" class="list-group-item list-group-item-action"><i class="fas fa-bookmark mr-1"></i>{{__('My Favorit')}}</a>
  <a href="{{url('/admincp/users/watchLater')}}" class="list-group-item list-group-item-action"><i class="fas fa-photo-video mr-1"></i>{{__('Watch Later')}}</a>
  <a href="{{url('/admincp/users/watchContinue')}}" class="list-group-item list-group-item-action"><i class="fas fa-tv mr-1"></i>{{__('Continue watching')}}</a>
</ul>
</div>
