...
<div class="container-xl mx-xl-auto">
  ...
  @foreach ($data as $v)
    ...
    @if ($Episodes->Where('sea_id',$Seasons->id)->firstWhere('episode_nm',$v->episode_number))
         ...
         <div class="col-lg-3 col-md-3 col-sm-4 col-6">
           <div class="card filmoqbox filmoq-box">
             ...
             <div id='d{{$v->episode_number}}'>
               <div id='{{$v->episode_number}}'  class="episode_btn filmoq filmoq-blue filmoq-left" tv="{{$Seasons->tv_id}}" season="{{$Seasons->id}}"><span><i class="mdi mdi-access-point mr-1"></i> {{__('Update')}}</span></div>
             </div>
