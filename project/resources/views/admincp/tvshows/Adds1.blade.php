@extends('master.add-post')
  ...
  @section('Post_id')
    ...
    <div class="col-12"> <div class="page-title-box"> <div class="page-title-right">
      ...
      <form action="{{ url('/admincp/tvshows/add/save') }}" enctype="multipart/form-data" method="post">
    ...
    <textarea name="editor">
     ...
     <div id="Data" class="collapse show">
      ...
      <div class="col-6 py-1 mb-0">
       ...
       <div class="col-md-4 col-6 py-1 mb-0">
       <input type="text" name="Ep_nm" class="form-control" placeholder="Ep_nm">
       </div>
       <div class="col-md-4 col-6 py-1 mb-0">
       <input type="text" name="Sea_nm" class="form-control" placeholder="Sea_nm">
       </div>
       <div class="col-md-4 col-6 py-1 mb-0">
      ...
      <div class="col-6">
        <div class="form-group row">
      <label for="example-input-normal" class="col-4 text-center col-form-label"
      >last_epdate</label>
      <div class="col-8">
      <input type="date" name="last_epdate" class="form-control" placeholder="last_epdate">
      </div></div></div>
      <div class="col-6">
        <div class="form-group row">
      <label for="example-input-normal" class="col-4 text-center col-form-label"
      >last_ep</label>
      <div class="col-8">
      <input type="date" name="last_ep" class="form-control" placeholder="last_ep">
      </div></div></div>
<div class="col-6">
 <div class="form-group row">
<label for="example-input-normal" class="col-4 text-center col-form-label"
>next_ep</label>
<div class="col-8">
<input type="date" name="next_ep" class="form-control" placeholder="next_ep">
</div></div></div>
