                          ...
                          <div class="card bg-pattern">
                              ...
                              <div class="card-body p-md-4 p-1">
                                  ...
                                  <div class="mt-3 text-center">
                                      ...
                                      <p class="text-muted font-14 mt-2">{{ __('Before proceeding, please check your email for a verification link.') }}
                                      {{ __('If you did not receive the email') }}, </p>

                                      <a href="index.html" class="btn btn-block btn-pink waves-effect waves-light mt-3">{{ __('click here to request another') }}</a>
                                  </div>
