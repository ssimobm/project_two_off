<!-- Footer Start -->
<footer class="footer" style="background-color: #232323!important;">
<div class="container-fluid">
<div class="row">
<div class="col-md-6">
2017 - <script>document.write(new Date().getFullYear())</script> &copy;  by <a href="">Simo_Kh_Bm</a>
</div>
<div class="col-md-6">
...
<div id="login-modal" class="modal fade" tabindex="-10" role="dialog" aria-hidden="true">
...
{{-- <script src="assets/js/simo.min.js"></script> --}}
    ...
    {{-- <script src="{{ asset('js/pages/filmoq.js') }}"></script> --}}
<!-- Gallery Init-->
