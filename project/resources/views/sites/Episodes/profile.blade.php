...
<div class="app-content content">
 ...
 <style>
 .card.simo {position:relative!important;top: 0;max-width: 100%;}body[data-sidebar-size=condensed] .footer, .footer {position: relative!important;background-color: #3c4752!important; width: 100%; background-color: #f4f5f7;left: 0!important; right: 0!important;}.tab-content { padding-bottom: 30px; }
.resp-container {
    position:relative;
    overflow: hidden;
 padding-top: 56%;
...
<div class="tab-pane" id="messages-fill" role="tabpanel" aria-labelledby="messages-tab-fill">
    ...
    {{-- dprofile-b2 --}}
    <div class="tab-profile container-lg" id="dprofile-b2">
    <div class="row  justify-content-center">
     <div class="col-md-12 col-12">
         <div class="grid-container">
    <div class="card card-body"> <h4 class="card-title text-center">




     {{$Data->where('simokey', 'tvshow_Title')->first()->simovalue}}
     <span class="spanReg"><span class="ribbon ribbon-primary"> ({{substr($Data->where('simokey', 'tvshow_First_Date')->first()->simovalue,'0','4')}})</span></span>
    </h4
    > <div class="card-text">
    ...
    <p class="card-text">
       <small class="text-muted">Last updated {{ (new \Carbon\Carbon)->parse($Data->where('simokey', 'tvshow_First_Date')->first()->simovalue)->diffForHumans()  }}</small>
     </p>
        ...
        $("#submit").click(function() {
          $.ajaxSetup({
            ...
            $.ajax({
                type: 'POST',
                dataType: 'html',
                url: "{{ url('movies/player') }}/{{$movies->id}}",
                success : function (data) {
                    $("#simoid2020").html('<style>.card.simo {position:relative!important;top: 0;max-width: 100%;}body[data-sidebar-size=condensed] .footer, .footer {position: relative!important;background-color: #3c4752!important; width: 100%; background-color: #f4f5f7;left: 0!important; right: 0!important;}.tab-content { padding-bottom: 30px; }</style>'+data);
...
{{-- dprofile-b2 --}}
  ...
  <div class="col-12" id="comments_all">
